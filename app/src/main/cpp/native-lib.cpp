 ...
 *
 * JNICALL
 * Java_cn_edu_bit_codesky_nativelearning_MainActivity_stringFromJNI(
 *        JNIEnv *env,
 *        jobject / * this * /) {
...
Java_cn_edu_bit_codesky_nativelearning_FaceDetectHelper_nativeInit( JNIEnv *env,
								    jobject instance )
{
/*    Android_JNI_GetEnv(); */
	...
	if ( mFaceDetectHelper == NULL )
	{
		...
		mFaceDetectHelper->setDetectFaceCallback([] (int ret,int left,int right,int top,int bottom) {
								 JNIEnv *_env = Android_JNI_GetEnv();
								 if ( _env != NULL && detectFaceCallbackMethod && mObj != NULL )
								 {
									 LOGD( "jni detectFaceCallbackMethod ret : %d", ret );
									 _env->CallStaticVoidMethod( (jclass) mObj, detectFaceCallbackMethod, ret,left,right,top,bottom );
								 }
							 } );
	}
}
...
extern "C"
JNIEXPORT void JNICALL
Java_cn_edu_bit_codesky_nativelearning_FaceDetectHelper_nativeDetectFace( JNIEnv *env,
									  jobject instance,
...
extern "C"
JNIEXPORT void JNICALL
Java_cn_edu_bit_codesky_nativelearning_FaceDetectHelper_nativeSetFaceDetectModelPath(
...
extern "C"
JNIEXPORT void JNICALL
Java_cn_edu_bit_codesky_nativelearning_FaceDetectHelper_nativeSetLicense( JNIEnv *env,
									  jobject instance,
									  jstring license_ )
{
...
extern "C"
JNIEXPORT void JNICALL
Java_cn_edu_bit_codesky_nativelearning_FaceDetectHelper_nativeUnInit( JNIEnv *env,
								      jobject instance )
{
	if ( mFaceDetectHelper != NULL )
	{
...
extern "C"
JNIEXPORT void JNICALL
Java_cn_edu_bit_codesky_nativelearning_FaceDetectHelper_nativeTestWriteBmp( JNIEnv *env,
									    jobject instance )
{
	if ( mFaceDetectHelper != NULL )
	{

...
public class FaceDetectHelper {
    ...
    public interface OnFaceDetectedCallback {
        void onFaceDetected(int ret, int left, int right, int top, int bottom);
    }
    ...
    public void onFaceDetectedCallback(int ret, int left, int right, int top, int bottom) {
        if (mFaceDetectedCallback != null) {
            mFaceDetectedCallback.onFaceDetected(ret, left, right, top, bottom);
        }
    }

    //TODO: add fact rect points through the params in the callback
    public static void nativeOnFaceDetectedCallback(int ret, int left, int right, int top, int bottom) {
        Log.d("FaceDetectHelper", "JAVA detectFaceCallbackMethod ret : " + ret);
        if (mHelper != null) {
            mHelper.onFaceDetectedCallback(ret, left, right, top, bottom);
        }
    }
